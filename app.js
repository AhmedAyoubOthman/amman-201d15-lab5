...
// Write your code here
 ...
 let x = sum(a,b); //sum(5,6)
 //  x=> [11, `The sum of 5 and 6 is 11.`]
 //x[0]
 let y = sum(x[0],c); //sum(11,7)
 //  y=> [18, `The sum of 11 and 7 is 11.`]


 let z = multiply(a,b);
 let r = multiply (z[0],c);

 return [y[0],r[0],`${a} and ${b} and ${c} sum to ${y[0]}.`, `The product of ${a} and ${b} and ${c} is ${r[0]}.`]
 }
...
function multiplyArray(multArr) {
  ...
  let multiplication = 1 ; 
    ...
    for (let i = 0; i < multArr.length; i++) {
      let n = multiply(multiplication, multArr[i])
      multiplication = n[0];
